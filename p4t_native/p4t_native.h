...
auto try_boolean_minimization(py::object classifier, bool use_resolution) -> py::object;
auto split(py::object classifier, int capacity, bool use_resolution) -> py::object;
